...
<!-- barra verticla -->
                        <div x-show="opened" class="fixed top-0 left-0 z-20 flex flex-col items-center justify-start h-screen pt-20 bg-gray-300 w-96">
                            <button class="py-8 mx-20 mt-2 text-2xl font-medium text-center bg-gray-500 rounded-lg font-montserrat">
                                <p>hola</p>
                            </button>
                            <button class="p-2 px-12 py-8 mt-4 text-2xl font-medium text-center bg-gray-500 rounded-lg font-montserrat">
                                <p>Reseñas</p>
                            </button>
                            <button class="p-2 py-8 mt-4 text-2xl font-medium text-center bg-gray-500 rounded-lg font-montserrat">
                                <p>Calendario</p>
                            </button>
                            <button class="p-2 px-12 py-8 mt-4 text-2xl font-medium text-center bg-gray-500 rounded-lg font-montserrat">
                                <p>Inicio</p>
        ...
        <label class="block px-20 pt-5 ">
            ...
            <div class="inline-flex w-full grid-cols-2">
                <input class="justify-end block w-full col-span-1 py-2 bg-white border rounded-full shadow-sm placeholder:text-slate-400 font-montserrat border-slate-300 pl-9 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search..." type="text" name="search"/>
                <button type="submit" class="p-2.5 ms-2 text-sm font-medium text-white shadow-sm bg-white rounded-full border border-slate-300 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        ...
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/></span>
                    <span class="sr-only">Search</span>
                </button>
            </div>
        </label>
