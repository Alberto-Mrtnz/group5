<x-layout>
    <div class="relative">
        ...
        <div x-data="{opened: false}" >
            <nav class="w-full bg-gray-300 grid-cols- z-20">
                <div class="inline-flex w-full">
                    <x-buttonicon2></x-buttonicon2>
                        <div class="py-1 pl-14 z-30">
...
<!-- barra verticla -->
        ...
        <label class=" block px-20 pt-5">
            ...
            <div class="inline-flex grid-cols-2 w-full">
                <input class="placeholder:text-slate-400 font-montserrat block col-span-1 justify-end bg-white w-full border border-slate-300 rounded-full py-2 pl-9 shadow-sm focus:outline-none focus:border-gray-500 focus:ring-gray-500 focus:ring-1 sm:text-sm" placeholder="Search..." type="text" name="search"/>
                <button type="submit" class="p-2.5 ms-2 text-sm font-medium text-white shadow-sm bg-white rounded-full border border-slate-300 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
