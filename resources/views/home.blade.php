...
<!-- buscador -->
            <label class="relative block px-20 pt-5">
                ...
                <div class="inline-flex grid-cols-2 w-full">
                    <input class="placeholder:text-slate-400 block col-span-1 justify-end bg-white w-full border border-slate-300 rounded-full py-2 pl-9 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search..." type="text" name="search"/>
