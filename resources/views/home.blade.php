...
<!-- barra verticla -->
                    <div x-show="opened"
                    class="fixed left-0 z-20 flex flex-col items-center justify-start h-screen pt-5 bg-gray-400 w-96 top-14">
                            <div class="w-full ml-6">
                            <button class="p-2 py-8 mt-2 text-2xl font-medium text-center bg-gray-500 rounded-lg px-14 font-montserrat">
                                <p>Servivios habilitados</p>
                            </button>
                        </div>

                            <div class="w-full ml-6">
                            <button class="p-2 px-32 py-8 mt-4 text-2xl font-medium text-center bg-gray-500 rounded-lg font-montserrat">
                                <p>Reseñas    </p>
                            </button>
                        </div>

                            <div class="w-full ml-6">
                            <button class="p-2 py-8 mt-4 text-2xl font-medium text-center bg-gray-500 rounded-lg px-28 font-montserrat">
                                <p>Calendario</p>
                            </button>
                        ...
                        <div class="w-full ml-6">
                        <button class="p-2 py-8 mt-4 text-2xl font-medium text-center bg-gray-500 rounded-lg px-36 font-montserrat">
                            <p>Inicio</p>
                        </button>
                        </div>
                        ...
                        <button>
                        <svg class="grid rounded-full justify-items-start size-10 hover:bg-gray-700" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M440-280h80v-160h160v-80H520v-160h-80v160H280v80h160v160Zm40 200q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
                        </button>
                        </div>
                    </div>
            </nav>
