...
<div class="relative">
    ...
    <div class="w-full h-screen mt-50">
        ...
        <div class="absolute inset-0 flex items-center justify-center">
            <h2 class="font-moon text-5xl text-white flex items-center justify-center">Donde encuentras los mejores lugares para tus eventos</h2>
        </div>
    </div>
